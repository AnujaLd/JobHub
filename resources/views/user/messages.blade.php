...
.custom-table th {
  background-color: #343a40; /* Dark gray header background color */
...
<a href="#" class="site-menu-toggle js-menu-toggle d-inline-block d-xl-none mt-lg-2 ml-3"><span class="icon-menu h3 m-0 p-0 mt-2"></span></a>
    ...
    <!-- HOME -->
    <section class="section-hero overlay inner-page bg-image" style="background-image: url('../assets/images/background.jpg');" id="home-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
